use utf8;
package LondonPM::TechMeet::Result::Speaker;
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JmdUQh2rPYi7XiBvVeocGA

__PACKAGE__->many_to_many(
  presentations => presentation_speakers => 'presentation',
);
